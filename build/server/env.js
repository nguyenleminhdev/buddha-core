...
exports.loadCurrentEnvConfig = void 0;
const chalk_1 = require("chalk");
/**nạp dữ liệu của môi trường hiện tại */
function loadCurrentEnvConfig(proceed) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        /**giá trị của mội trường hiện tại */
        const NODE_ENV = process.env.NODE_ENV || 'development';
        /**dữ liệu của môi trường hiện tại */
        const ENV = yield (_a = `${process.cwd()}/src/config/env/${NODE_ENV}`, Promise.resolve().then(() => __importStar(require(_a))));
...
exports.loadCurrentEnvConfig = loadCurrentEnvConfig;
